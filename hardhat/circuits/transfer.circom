...
template Transfer() {
    ...
    signal input ephemeralKey[8];
    signal input ercAddressTransfer;
    signal input idTransfer[8];
...
component main {public [value, fee, transactionType, tokenType, historicRootBlockNumberL2, tokenId, ercAddress, recipientAddress, commitments, nullifiers, compressedSecrets]} = Transfer();
